...
function addUser(event) {
    ...
    if(errorCount === 0) {
        ...
        var newUser = {
            ...
            'userid': $('#addUser fieldset input#inputUserId').val(),
            'university': $('#addUser fieldset input#inputUserUniversity').val(),
            'grade': $('#addUser fieldset input#inputUserGrade').val(),
            'part': $('#addUser fieldset input#inputUserPart').val(),
            'music': $('#addUser fieldset input#inputUserMusic').val()
        }
